    ...
    return (
        ...
        <div className={styles.Gracias}>
            ...
            >
                ...
                <p>Cualquier duda podes escribirnos por <a href={WHATSAPP_LINK} target="_blank">Whatsapp</a> o enviarnos un mail a <a href="mailto:hola@lengaswear.com">hola@lengaswear.com</a></p>
            </motion.main>
        </div>
        </>
    )
